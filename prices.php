		...
		<div class="row">
			<div class="span8 offset1" id="main" role="main">
				<article>
					...
					<p>*I've never built one of these, I just threw it in for a bit of spice.</p>
				...
				<article>
		            ...
		            <h4>Notes</h4>
					<p><a name="callout">*</a> Callout charges may be higher than stated based on your location - please double check with us first.</p>
					<p><a name="devices">**</a> The following items count as a Device: Desktop PC (<strong>including</strong> monitor), Laptop, Server, Printer, Scanner, Router, Hub, Wireless Access Point and other similar items. </p>
				</article>
			</div><!-- /#main -->
			<div class="span3">
