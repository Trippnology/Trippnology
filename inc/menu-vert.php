<nav class="vert-menu">
    <ul class="nav nav-list">
		...
		<li><a href="bs/docs/less.html" target="_blank" class="tooltip-right" title="Customize and extend Bootstrap with LESS, a CSS preprocessor, to take advantage of the variables, mixins, and more used to build Bootstrap's CSS."><i class="icon-info-sign"></i> Using Less</a>
		<li><a href="bs/docs/download.html" target="_blank" class="tooltip-right" title="Download the full repository or customize your entire Bootstrap build by selecting only the components, javascript plugins, and assets you need."><i class="icon-info-sign"></i> Customise</a>
		<li><a href="bs/docs/examples.html" target="_blank" class="tooltip-right" title="We've included a few basic examples as starting points for your work with Bootstrap. We encourage folks to iterate on these examples and not simply use them as an end result."><i class="icon-info-sign"></i> Examples</a>
