<nav class="vert-menu">
    <ul class="nav nav-list">
		...
		<li><a href="bs/docs/getting-started.html" target="_blank" class="tooltip-right" title="We'll focus on getting started with the compiled Bootstrap files."><i class="icon-info-sign"></i> Getting started</a></li>
