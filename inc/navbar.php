					...
					<li class="dropdown" id="bootstrapmenu">
						<a href="#bootstrapmenu" class="dropdown-toggle" data-toggle="dropdown">Bootstrap<b class="caret"></b></a>
							<ul class="dropdown-menu">
								...
								<li><a href="bs/docs/less.html" target="_blank" class="tooltip-right" title="Customize and extend Bootstrap with LESS, a CSS preprocessor, to take advantage of the variables, mixins, and more used to build Bootstrap's CSS.">Using Less</a></li>
								<li><a href="bs/docs/download.html" target="_blank" class="tooltip-right" title="Download the full repository or customize your entire Bootstrap build by selecting only the components, javascript plugins, and assets you need.">Customise</a></li>
								<li><a href="bs/docs/examples.html" target="_blank" class="tooltip-right" title="We've included a few basic examples as starting points for your work with Bootstrap. We encourage folks to iterate on these examples and not simply use them as an end result.">Examples</a></li>
							</ul>
					</li>
